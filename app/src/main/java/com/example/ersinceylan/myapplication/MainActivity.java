...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Tiger Enterprise 3");
        setContentView(R.layout.activity_main);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        String[] foods = {"Bacon","Ersin","Ceylan","Furkan"};
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        {
            SecondFragment secondFragment = SecondFragment.newInstance("sa","as");
            FragmentManager fragmentManager = getSupportFragmentManager();
        ...
        else if (id == R.id.nav_share)
        {
            ...
            FragmentManager fragmentManager = getSupportFragmentManager();
            fragmentManager.beginTransaction().replace(R.id.relativeForFragment,billFragment,billFragment.getTag()).commit();
